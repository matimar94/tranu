...
TRANU_PYGLET_BACKEND = 2

TRANU_DEFAULT_BACKEND = TRANU_PYGLET_BACKEND

tranu_backend = TRANU_DEFAULT_BACKEND

TRANU_WEB = (TRANU_CANVAS_BACKEND,)
TRANU_NATIVE = (TRANU_PYSDL2_BACKEND, TRANU_PYGLET_BACKEND)

TRANU_BACKEND_MAPPER = { "CANVAS":TRANU_CANVAS_BACKEND, "PYSDL2":TRANU_PYSDL2_BACKEND, "PYGLET":TRANU_PYGLET_BACKEND }
